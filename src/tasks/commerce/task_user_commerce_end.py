"""Task para manejar USER_COMMERCE_END enviado por el cliente."""
...
class TaskUserCommerceEnd(Task):
    """Cancela la sesión de comercio del jugador."""
    ...
    def __init__(
        ...
        """Inicializa la task de cancelación de comercio."""
        super().__init__(data, message_sender)
        self.trade_update_handler = trade_update_handler
        self.session_data = session_data or {}

    async def execute(self) -> None:
        """Cancela el comercio actual del jugador."""
