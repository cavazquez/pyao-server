...
HANDLER_CONFIGS: dict[str, HandlerConfig] = {
    ...
    "drop": HandlerConfig(
        DropCommandHandler,
        deps_keys=[
            "player_repo", "inventory_repo", "map_manager", "broadcast_service", "item_catalog",
        ],
    ),
    "pickup": HandlerConfig(
        PickupCommandHandler,
        deps_keys=[
            "player_repo", "inventory_repo", "map_manager", "broadcast_service",
            "item_catalog", "party_service",
        ],
    ),
    "use_item": HandlerConfig(
        UseItemCommandHandler,
        deps_keys=[
            "player_repo", "map_resources_service", "account_repo",
            "item_catalog", "broadcast_service", "map_manager",
        ],
    ),
    ...
    "walk": HandlerConfig(
        WalkCommandHandler,
        deps_keys=[
            "player_repo", "map_manager", "broadcast_service", "stamina_service",
            "player_map_service", "inventory_repo", "map_resources_service",
        ],
    ),
    "attack": HandlerConfig(
        AttackCommandHandler,
        deps_keys=[
            "player_repo", "combat_service", "map_manager", "npc_service", "broadcast_service",
            "npc_death_service", "npc_respawn_service", "loot_table_service",
            "item_catalog", "stamina_service",
        ],
    ),
    ...
    "left_click": HandlerConfig(
        ...
        deps_keys=[
            "player_repo", "map_manager", "map_resources_service", "bank_repo",
            "merchant_repo", "door_service", "door_repo", "redis_client",
        ],
    ),
    # Handlers de party
    ...
    "talk": HandlerConfig(
        TalkCommandHandler,
        deps_keys=[
            "player_repo", "account_repo", "map_manager", "game_tick",
            "clan_service", "trade_service", "npc_service", "summon_service",
        ],
        needs_session_data=True,
    ),
    "login": HandlerConfig(
        LoginCommandHandler,
        deps_keys=[
            "player_repo", "account_repo", "map_manager", "server_repo",
            "spellbook_repo", "spell_catalog", "equipment_repo", "player_map_service",
        ],
        needs_session_data=True,
    ),
    "create_account": HandlerConfig(
        ...
        deps_keys=[
            "player_repo", "account_repo", "map_manager", "npc_service", "server_repo",
            "spellbook_repo", "spell_catalog", "equipment_repo", "player_map_service",
        ],
        needs_session_data=True,
    ),
