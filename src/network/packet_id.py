...
class ClientPacketID(IntEnum):
    ...
    REQUEST_MOTD = 89
    UPTIME = 90
    PARTY_LEAVE = 91  # /SALIRPARTY - Abandonar party
    PARTY_CREATE = 92  # /CREARPARTY - Crear nueva party
    PARTY_JOIN = 93  # /PARTY - Invitar a party
    # INQUIRY = 94
    # GUILD_MESSAGE = 95
    PARTY_MESSAGE = 96  # /PMSG - Mensaje de party
    # CENTINEL_REPORT = 97
    # GUILD_ONLINE = 98
    # PARTY_ONLINE = 99
    # COUNCIL_MESSAGE = 100
    ...
    # GUILD_FUNDATE = 114
    # GUILD_FUNDATION = 115
    PARTY_KICK = 116  # Expulsar miembro de party
    PARTY_SET_LEADER = 117  # Transferir liderazgo de party
    PARTY_ACCEPT_MEMBER = 118  # /ACCEPTPARTY - Aceptar invitación
    PING = 119
