...
class TestDamageCalculator:
    ...
    def test_calculate_player_damage_basic(self) -> None:
        ...
        with patch("src.combat.combat_damage_calculator.random.random", return_value=1.0):
    ...
    def test_calculate_player_damage_with_critical(self) -> None:
        ...
        with patch("src.combat.combat_critical_calculator.random.random", return_value=0.01):
            damage, is_critical = calculator.calculate_player_damage(
                strength=20,
                weapon_damage=10,
                target_level=5,
    ...
    def test_calculate_npc_damage_minimum(self) -> None:
        ...
        with patch("src.combat.combat_damage_calculator.random.uniform", return_value=0.8):
            damage = DamageCalculator.calculate_npc_damage(
                npc_level=1,
                armor_reduction=0.9,
            )
