...
class TestRewardCalculator:
    ...
    def test_calculate_experience_level_1(self) -> None:
        ...
        with patch("src.combat_reward_calculator.random.randint", return_value=0):
    ...
    def test_calculate_experience_level_5(self) -> None:
        ...
        with patch("src.combat_reward_calculator.random.randint", return_value=5):
    ...
    def test_calculate_experience_level_10(self) -> None:
        ...
        with patch("src.combat_reward_calculator.random.randint", return_value=10):
    ...
    def test_calculate_gold_drop_level_1(self) -> None:
        ...
        with patch("src.combat_reward_calculator.random.randint", return_value=1):
    ...
    def test_calculate_gold_drop_level_5(self) -> None:
        ...
        with patch("src.combat_reward_calculator.random.randint", return_value=25):
    ...
    def test_calculate_gold_drop_level_10(self) -> None:
        ...
        with patch("src.combat_reward_calculator.random.randint", return_value=50):
    ...
    def test_high_level_rewards(self) -> None:
        ...
        with patch("src.combat_reward_calculator.random.randint", return_value=20):
