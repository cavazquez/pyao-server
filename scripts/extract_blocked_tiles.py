...
def extract_all_maps(maps_dir: str = "./clientes/ArgentumOnlineGodot/Assets/Maps") -> dict[int, dict[tuple[int, int], bool]]:
...
def generate_toml_config(all_blocked_tiles: dict[int, dict[tuple[int, int], bool]], output_file: str = "data/map_blocked_tiles.toml") -> None:
